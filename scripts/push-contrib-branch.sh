...
readonly branch_name="pytorch-lightning-$tag"

git checkout -b "$branch_name"
cd docsets/PytorchLightning

readonly tgz_name="PytorchLightning.tgz"
...
git add -A
git commit -m "PytorchLightning.docset $tag"

git push \
	"https://${CI_USER_USERNAME}:${CI_USER_ACCESS_TOKEN}@github.com/munhouiani/Dash-User-Contributions.git" \
	"HEAD:$branch_name"
